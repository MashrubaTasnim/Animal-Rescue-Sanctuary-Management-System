...
if (isset($_POST['send_otp_btn'])) {
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        $update = mysqli_query($conn, "UPDATE users SET reset_otp='$otp', token_expire='$expire' WHERE email='$email'");
        ...
        if ($update) {
            ...
            try {
                ...
                $mail->Body    = "
                    <div style='font-family: Arial, sans-serif; padding: 20px; border: 1px solid #ffefc2; border-radius: 10px; background-color: #0a1329; color: white;'>
                        <h2 style='color: #ffefc2;'>Password Reset Request</h2>
                        <p>Hello,</p>
                        <p>Your OTP for resetting your password is:</p>
                        <div style='font-size: 32px; font-weight: bold; color: #0a1329; background: #ffefc2; padding: 10px; display: inline-block; border-radius: 5px;'>$otp</div>
                        <p>This code is valid for <b>15 minutes</b> only.</p>
                        <p>If you didn't request this, please ignore this email.</p>
                        <br>
                        <p>Regards,<br><b>$site_name Team</b></p>
                    </div>";
...
<head>
    ...
    <title>Forgot Password | <?= setting('site_name', 'Heartbeat Heaven') ?></title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-line a:hover { color: var(--gold-light); border-color: var(--gold-light); }
...
<body>
    ...
    <div class="page-center">
        ...
        <div class="card">
            ...
            <p class="card-subtext">Enter your email to receive a recovery code</p>
            ...
            <form method="POST">
                ...
                <button type="submit" name="send_otp_btn" class="btn-login">Send OTP Code</button>
            </form>

            <div class="back-line">
                <a href="login.php"><i class="fas fa-arrow-left" style="font-size:0.7rem; margin-right:5px;"></i>Back to Sign In</a>
            </div>
        </div>
